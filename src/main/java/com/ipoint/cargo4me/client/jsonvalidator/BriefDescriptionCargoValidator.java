 ...
 *
 */
public class BriefDescriptionCargoValidator implements JSONValidator {

	/* (non-Javadoc)
	 * @see com.ipoint.cargo4me.client.jsonvalidator.JSONValidator#validate(java.lang.String)
	 */
	@Override
